...
class TerraformRepositoryNameStandardListener extends EventListener {
  ...
  public static final VALID_MODULE_REPOSITORY_NAME_PATTERN = /^terraform\-(module|ecosystem)\-(aws|azurerm|azuread|google|bitbucket|gitlab|github|kubernetes|multi)-[a-z\d]{3,}([a-z\d\-]+)?$/
